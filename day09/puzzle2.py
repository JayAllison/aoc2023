...
for history in histories:
    # part 2 asks us to work to the left, so let's just reverse the input, then our existing code will just work
    history.reverse()
    ...
    # working backwards, predict the previous value at each stage, until we have a projection for the original history
    deltas[-1].append(0)
